...
void LlmClient::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->uploadProgressChanged((*reinterpret_cast<std::add_pointer_t<qint64>>(_a[1])),(*reinterpret_cast<std::add_pointer_t<qint64>>(_a[2]))); break;
        case 3: _t->diagnosticLog((*reinterpret_cast<std::add_pointer_t<QString>>(_a[1]))); break;
        case 4: _t->onReplyFinished(); break;
        case 5: _t->onPayloadReady((*reinterpret_cast<std::add_pointer_t<QByteArray>>(_a[1]))); break;
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        ...
        if (QtMocHelpers::indexOfMethod<void (LlmClient::*)(const QString & )>(_a, &LlmClient::errorOccurred, 1))
            return;
        if (QtMocHelpers::indexOfMethod<void (LlmClient::*)(qint64 , qint64 )>(_a, &LlmClient::uploadProgressChanged, 2))
            return;
        if (QtMocHelpers::indexOfMethod<void (LlmClient::*)(const QString & )>(_a, &LlmClient::diagnosticLog, 3))
            return;
    }
}
...
// SIGNAL 2
void LlmClient::uploadProgressChanged(qint64 _t1, qint64 _t2)
{
    QMetaObject::activate<void>(this, &staticMetaObject, 2, nullptr, _t1, _t2);
}

// SIGNAL 3
void LlmClient::diagnosticLog(const QString & _t1)
{
